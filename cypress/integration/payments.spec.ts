...
describe("Checkout Payments", () => {
  ...
  context.skip("customer order with one payment method not selected", () => {
    before(function () {
      cy.getTokenCustomer({
        username: email,
        password: password,
  ...
  context.skip("guest order with one payment method not selected", () => {
    before(function () {
      cy.createOrder("draft", {
        languageCode: "en",
        customerEmail: email,
  ...
  context.skip("select one method and change immediately", () => {
    before(function () {
      cy.createOrder("draft", {
        languageCode: "en",
        customerEmail: email,
  ...
  context.skip("customer order and braintree select method", () => {
    before(function () {
      cy.getTokenCustomer({
        username: email,
        password: password,
  ...
  context.skip("customer order select Adyen payment method", () => {
    before(function () {
      cy.getTokenCustomer({
        username: email,
        password: password,
  ...
  context.skip(
    "customer order select card to wallet Adyen payment method",
    () => {
      before(function () {
        cy.getTokenCustomer({
          username: email,
      ...
      it("place order and redirect", () => {
        ...
        cy.dataCy("place-order-button").click()
        cy.wait(
          ["@updateOrder", "@getOrders", "@getOrders", "@paymentMethods"],
          {
            timeout: 100000,
          }
        )
