        ...
        <CouponFormWrapper>
          <CouponFieldWrapper>
            ...
            <GiftCardOrCouponSubmit
              ...
              className={`w-auto -ml-px relative inline-flex items-center space-x-2 px-8 py-3 text-xs font-extrabold text-white bg-primary border border-transparent rounded-r-md hover:opacity-80 focus:outline-none`}
            />
          </CouponFieldWrapper>
          <StyledErrors
            resource="order"
