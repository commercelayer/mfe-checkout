import type { PaymentMethod } from "@commercelayer/react-components"
import type { ComponentProps } from "react"
import { useTranslation } from "react-i18next"

export type PaymentMethodConfig = NonNullable<
  ComponentProps<typeof PaymentMethod>["config"]
>

/**
 * The gateway configuration that used to be handed to
 * `<PaymentMethodsContainer>`. The standalone `<PaymentMethod>` takes it
 * directly, so this is a hook now rather than a wrapper component.
 */
